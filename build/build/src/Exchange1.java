...
public class Exchange1 {
    ...
    Label exchangePrompt = new Label("Exchange their keys!");
    exchangePrompt.setFont(new Font(font));
    exchangePrompt.setTranslateY(-350);
    layout2.getChildren().add(exchangePrompt);
